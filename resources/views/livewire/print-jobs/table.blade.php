        ...
        <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-800">
            ...
            <tr>
                ...
                <dl class="font-normal lg:hidden">
                    ...
                    <dd class="mt-1 text-gray-700 truncate dark:text-gray-400">{{ $job->model }}</dd>
                    <dt class="sr-only sm:hidden">Spool</dt>
                    <dd class="mt-1 text-gray-500 truncate dark:text-gray-200 sm:hidden">{{ $job->spool }}</dd>
                </dl>
                </td>
                <td class="hidden px-3 py-4 text-sm text-gray-500 dark:text-gray-400 lg:table-cell">{{ $job->model }}</td>
                <td class="hidden px-3 py-4 text-sm text-gray-500 dark:text-gray-400 sm:table-cell">{{ $job->spool->name ?? 'None loaded' }}</td>
