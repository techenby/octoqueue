<x-ui.card title="Temperature" class="overflow-hidden md:col-span-2">
                ...
                <tr>
                    ...
                    <x-ui.td>
                        <form wire:submit.prevent="setTarget('{{ $name }}')">
                            ...
                            <div class="flex">
                                <input type="number" wire:model="temps.{{ $name }}.target" name="{{ $name }}-target-temp" id="{{ $name }}-target-temp" placeholder="0" class="block w-24 border-gray-300 rounded-none dark:border-gray-700 dark:bg-gray-800 rounded-l-md focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                    ...
                    <x-ui.td>
                        <form wire:submit.prevent="setOffset('{{ $name }}')">
                            ...
                            <div class="flex">
                                <input type="number" wire:model="temps.{{ $name }}.offset" name="{{ $name }}-offset-temp" id="{{ $name }}-offset-temp" placeholder="0" class="block w-24 border-gray-300 rounded-none dark:border-gray-700 dark:bg-gray-800 rounded-l-md focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
