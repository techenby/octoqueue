<x-jet-form-section submit="save">
    ...
    <x-slot name="form">
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-form.input id="name" type="text" class="block w-full mt-1" wire:model="printer.name" placeholder="Friendly name for printer" autofocus />
            <x-jet-input-error for="printer.name" class="mt-2" />
        </div>

        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="model" value="{{ __('Model') }}" />
            <x-form.input id="model" type="text" class="block w-full mt-1" wire:model="printer.model" placeholder="Ender 3 Pro" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <div class="relative flex items-stretch flex-grow mt-1 focus-within:z-10">
                <x-form.input id="url" type="url" class="block w-full rounded-r-none" wire:model="printer.url" placeholder="https://octoeverywhere.com/shared-url" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-form.input id="api_key" type="password" class="block w-full mt-1" wire:model="printer.api_key" placeholder="String from OctoPrint" />
