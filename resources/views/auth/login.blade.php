    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mt-4">
                ...
                <x-form.input id="password" class="block w-full mt-1" type="password" name="password" required autocomplete="current-password" />
            </div>
            ...
            <div class="flex items-center justify-end mt-4">
                @if (Route::has('password.request'))
                    <a class="text-sm text-gray-600 underline dark:text-gray-400 dark:hover:text-gray-200 hover:text-gray-900" href="{{ route('password.request') }}">
